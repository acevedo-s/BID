...
from dadapy._utils.GD_hamming import *
...
delta = 5E-2                # stochastic optimization step 
Nsteps = int(2E1)            # number of optimization steps
seed = 1                     # 
optfolder0 = f'results/opt/' # folder where optimization results are saved
export_logKLs = 0            # flag to export the logKLs during optimization
